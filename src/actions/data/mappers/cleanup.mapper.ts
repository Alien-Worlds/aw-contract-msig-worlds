...
// Mongo Mappers
export class CleanupMongoMapper extends MongoMapper<
  Cleanup,
  CleanupMongoModel
> {
  constructor() {
...
// Raw mappers
export class CleanupRawMapper extends MapperImpl<Cleanup, CleanupRawModel> {
  ...
  public toEntity(rawModel: CleanupRawModel): Cleanup {
    ...
    return Cleanup.create(proposal_name || '', dac_id || '', undefined, rest);
  }
}
